...
class FillSelect extends Component {
    funcCode = 20;
    ...
    render(){
        ...
        const nameLang = 'horizontalBarComponent.FillSelect'
        // const descLang = 'horizontalBarComponent.FillSelect.desc';
        return(
...
export default connect(mapStateToProps,mapDispatchToProps)(FillSelect)